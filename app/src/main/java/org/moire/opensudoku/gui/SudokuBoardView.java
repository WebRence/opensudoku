...
public class SudokuBoardView extends View {
    ...
    public Paint getmCellValueInvalidPaint() {
        return mCellValueInvalidPaint;
    }
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        mCellValueInvalidPaint = getPaintForCell(getInValidCellColor());
        setCanvasColors(context, attrs);
    }

    private String getInValidCellColor() {
        return "white";
    }

    //FF32FF
    private String getShaderTouched() {
        return "yellow";
//        return "#00000000";
    }

    private Paint getPaintForCell(String color) {
        Paint mCellValueInvalidPaint = new Paint();
        mCellValueInvalidPaint.setAntiAlias(true);
        mCellValueInvalidPaint.setColor(Color.parseColor(color));
        return mCellValueInvalidPaint;
    }

    private void setCanvasColors(Context context, AttributeSet attrs) {
        ...
        setBackgroundColorTouched(a.getColor(R.styleable.SudokuBoardView_backgroundColorTouched, Color.YELLOW)); //Color.rgb(255, 50, 255)
...
//        Log.d(TAG, "heightSize=" + heightSize);
    ...
    private Paint getPaintForCell(Cell cell) {
